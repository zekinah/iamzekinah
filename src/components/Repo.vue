        ...
        <div class="content">
          ...
          <div class="repo__stats levels">
            <div class="level-left">
              <div class="repo__language level-item">{{data.language}}</div>
              <div class="repo__starcount level-item">
                <span class="icon">
                  <svg style="width:24px;height:24px" viewBox="0 0 24 24">
              ...
              <div class="repo__forkcount level-item">
                <span class="icon">
                  <svg style="width:24px;height:24px" viewBox="0 0 24 24">
              ...
              <span class="repo__size level-item">{{data.size}} KB</span>
            </div>
          </div>
        </div>
      </div>
